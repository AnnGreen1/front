...
参考：[组件](https://v2.cn.vuejs.org/v2/guide/components.html)
...
参考：[深入响应式原理](https://v2.cn.vuejs.org/v2/guide/reactivity.html)
...
* 参考：[过滤器](https://v2.cn.vuejs.org/v2/guide/filters.html)
...
* 参考：[插件](https://v2.cn.vuejs.org/v2/guide/plugins.html)
...
* **参考**：[全局混入](https://v2.cn.vuejs.org/v2/guide/mixins.html#%E5%85%A8%E5%B1%80%E6%B7%B7%E5%85%A5)
...
* **参考**：[实例方法 / 数据 - vm.$watch](https://v2.cn.vuejs.org/v2/api/#vm-watch)
...
##### slot-scope <font color=red>废弃</font>
**推荐 2.6.0 新增的 v-slot**。
...
- 请参考 VNode class declaration。

### 服务端渲染

- 请参考 vue-server-renderer package documentation。