...
**起步**
[Vue Test Utils](https://github.com/vuejs/vue-test-utils) 是 Vue 组件单元测试的官方库。Vue CLI 的 `webpack` 模板对 Karma 和 Jest 这两个测试运行器都支持，并且在 Vue Test Utils 的文档中有一些引导。
...
我们在 Vue Test Utils 的教程中提供了更完整的示例展示这些测试。
